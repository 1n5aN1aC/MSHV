        ...
        : QWidget(parent)
{
    ...
    sb_idle_ar_candidate_seconds->setValue(90);
    ...
    le_idle_contest_call->setValidator(new QRegExpValidator(QRegExp("[A-Za-z0-9]{0,4}"), this));// CQ tags are alphanumeric; also keeps '#' out of the settings serialization
